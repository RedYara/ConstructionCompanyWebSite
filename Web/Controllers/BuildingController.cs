using Application.CQRS.Commands.Building.CreateBuilding;
using Application.CQRS.Commands.Building.DeleteBuilding;
using Application.CQRS.Commands.Building.EditBuilding;
using Application.CQRS.Queries.Buildings.GetBuildingDetailsQuery;
...
namespace Web.Controllers
{
    ...
    [Authorize]
    public class BuildingController(IMapper mapper, WebDbContext dbContext) : BaseController
    {
